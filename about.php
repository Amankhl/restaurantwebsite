<section class="section about text-center" aria-labelledby="about-label" id="about">
        <div class="container">
          ...
          <div class="about-content">
            ...
            <a href="tel:+804001234567" class="body-1 contact-number hover-underline">+911143065200</a>
          ...
          <figure class="about-banner">
            ...
            <img src="./assets/images/event-1.jpg" width="570" height="570" loading="lazy" alt="about banner"
          ...
          <img src="./assets/images/shape3.png" width="197" height="194" loading="lazy" alt="" class="shape">
