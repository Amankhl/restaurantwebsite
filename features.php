<section class="section features text-center" aria-label="features">
        <div class="container">
          ...
          <img src="./assets/images/shape7.png" width="100" height="100" style="margin-right: 10px;" loading="lazy" alt="shape"
            class="shape shape-1">

          <!-- <img src="./assets/images/" width="160" height="155" loading="lazy" alt="shape" class="shape shape-2"> -->
